public interface Segment {
	 ...
	 * <li>Inne wartości są niedozwolone i jeżeli wystąpią odcinek nie powinien być
	...
	/**
	 * Metoda zwraca długość odcinka. Długość to liczba "pikseli", któłre należą do
	 * odcinka.
	 * 
