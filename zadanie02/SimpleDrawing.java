public interface SimpleDrawing {
	 ...
	 * poprzedniego. <br>
	 * UWAGA: obszar płótna jest ograniczony. Jeżeli długość zleconego do narysowania
	...
	/**
	 * Metoda zwraca dwuwymiarową tablicę liczb całkowitych reprezentujących aktualny
