...
public interface LinesInterface {
	...
	public interface Segment {
		 ...
		 * 
		 * @return punkt będącyy drugim krańcem odcinka
		 */
	 ...
	 * @return lista kolejnych odcinkĂłw prowadzących od start do end.
	 */
	 ...
	 * ścieżek. We wskazywanej przez punkt mapie mają znależć się punkty, które
